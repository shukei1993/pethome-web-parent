<template>
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="query">
                <el-form-item label="宠物名">
                    <el-input v-model="query.name" placeholder="宠物名"></el-input>
                </el-form-item>
        ...
        <el-table :data="listData" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
                ...
                <template slot-scope="props">
                    <el-form label-position="left" inline class="demo-table-expand">
                        ...
                        <!--<el-form-item label="领养须知">
                            <span>{{ props.row.petDetail.adoptNotice }}</span>
                        </el-form-item>
                        <el-form-item label="宠物简介">
                            <span>{{ props.petDetail.intro }}</span>
                        </el-form-item>-->
                        <el-form-item label="状态">
            ...
            <el-table-column prop="saleprice" label="售价" width="200"></el-table-column>
        ...
        <el-dialog title="新增" :visible.sync="saveFormVisible" :close-on-click-modal="false">
            <el-form :model="saveForm" label-width="80px" :rules="saveFormRules" ref="saveForm">
                ...
                <el-form-item label="宠物简介" prop="costprice">
                    <quill-editor v-model="saveForm.petDetail.intro" :options="quillConfig" auto-complete="off"></quill-editor>
                </el-form-item>
                <el-form-item label="领养须知" prop="costprice">
                    <quill-editor v-model="saveForm.petDetail.adoptNotice" :options="quillConfig" auto-complete="off"></quill-editor>
                </el-form-item>
            </el-form>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadListData() {
                // post请求
                this.$http.post("/pet/queryPage", this.query).then(res => {
                    // 取出返回的total和list数据
            ...
            saveSubmit() { // 双向绑定数据就在saveForm中
                this.$confirm('确认提交吗?', '提示', {
                    ...
                    console.debug(this.fileList);
                    // 发送请求
                    this.$http.put("/pet", this.saveForm).then(res => {
                        // 开启加载效果
